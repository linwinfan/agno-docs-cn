...
This example shows how to use structured output with IBM WatsonX. It defines a Pydantic 模型 `MovieScript` with various fields and their descriptions, then creates an 智能体 using this 模型 as the `output_schema`. The 模型's output will be parsed into this structured format.