...
description: Create PowerPoint presentations, Excel spreadsheets, Word 文档s, and analyze PDFs with Claude Agent Skills
---

[Claude Agent Skills](https://docs.claude.com/en/docs/智能体s-and-tools/智能体-skills/overview) provide 功能 beyond what can get done with prompts alone.
...
You can read 更多功能 about how **Skills** work on [Anthropic docs](https://docs.claude.com/en/docs/智能体s-and-tools/智能体-skills/overview#how-skills-work).

## Available Skills

- **PowerPoint (pptx)**: Create professional presentations with slides, layouts, and formatting
- **Excel (xlsx)**: Generate spreadsheets with formulas, charts, and 数据 analysis
- **Word (docx)**: Create and edit 文档s with rich formatting
- **PDF (pdf)**: Analyze and extract information from PDF 文档s

You can also create custom skills for Claude to use. You can read 更多功能 about that on [Anthropic docs](https://docs.claude.com/en/docs/智能体s-and-tools/智能体-skills/overview#custom-skills-examples).
...
2. **Anthropic API key** with access to Claude 模型s
3. **Beta access** to Claude Agent Skills

## File Download Helper Setup

<Warning>
**Important:** Files created by Agent Skills are NOT automatically saved to your 本地 filesystem. They are created in a sandboxed execution environment and must be downloaded using the Anthropic Files API.
...
Save the 以下 code as `file_download_helper.py` in your project directory:
...
Enable skills by passing them to the Claude 模型 configuration:
...
Generate spreadsheets with formulas, charts, and 数据 analysis.
...
Create and edit 文档s with rich formatting.
...
Combine multiple skills for comprehensive 文档 packages.
...
<Steps>
  ...
  <Step title="Run Example">
    Create a Python file with any of the examples above 并运行:
...
- Skills require 模型s with code execution capability

### Beta Version

Skills require the 以下 beta flags:
- `code-execution-2025-08-25`
- `skills-2025-10-02`

### Skill Configuration

Specify skills in the 模型 configuration:
...
- [Claude Agent Skills Documentation](https://docs.anthropic.com/en/docs/智能体s-and-tools/智能体-skills/quickstart)
