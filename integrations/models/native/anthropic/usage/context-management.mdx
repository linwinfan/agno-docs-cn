...
description: Learn how to use Anthropic's context editing 功能 with Agno.
---

With Anthropic's [context editing 功能](https://docs.anthropic.com/en/docs/build-with-claude/context-editing), you can automatically manage your context size.
