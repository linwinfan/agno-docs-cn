---
title: Discord Bot
description: Host 智能体s as Discord Bots.
sidebarTitle: 概览
---

The Discord Bot 集成 allows you to serve Agents or Teams via Discord, using the discord.py library to handle Discord events and send messages.
...
Create an 智能体, wrap it with `DiscordClient`, 并运行 it:
...
- `DiscordClient`: Wraps Agno 智能体s/teams for Discord 集成 using discord.py.
...
| --------- | ----------------- | ------- | ------------------------------------- |
| `智能体`   | `Optional[Agent]` | `None`  | Agno `Agent` instance.                |
| `team`    | `Optional[Team]`  | `None`  | Agno `Team` instance.                 |

*Provide `智能体` or `team`, not both.*
...
- **Files**: Downloads and processes 文档 attachments

## Environment Variables

Ensure the 以下 environment variable is set:
...
The bot processes messages with the 以下 workflow:
...
4. **Agent/Team Execution**: Forwards the message and media to the configured 智能体 or team
