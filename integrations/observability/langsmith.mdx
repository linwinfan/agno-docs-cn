---
title: LangSmith
description: Integrate Agno with LangSmith to send traces and gain insights into your 智能体's performance.
---

## Integrating Agno with LangSmith

LangSmith offers a comprehensive 平台 for tracing and monitoring AI 模型 calls. By integrating Agno with LangSmith, you can utilize OpenInference to send traces and gain insights into your 智能体's performance.
...
This example demonstrates how to instrument your Agno 智能体 with OpenInference and send traces to LangSmith.
...
- **Data Regions**: Choose the appropriate `LANGSMITH_ENDPOINT` based on your 数据 region.

By 以下 these steps, you can effectively integrate Agno with LangSmith, enabling comprehensive observability and monitoring of your AI 智能体s.