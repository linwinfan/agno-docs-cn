---
title: OpenLIT
description: Integrate Agno with OpenLIT for OpenTelemetry-原生 observability, tracing, and monitoring of your AI 智能体s.
---

## Integrating Agno with OpenLIT

[OpenLIT](https://github.com/openlit/openlit) is an open-source, self-hosted, OpenTelemetry-原生 平台 for a continuous feedback loop for testing, tracing, and fixing AI 智能体s. By integrating Agno with OpenLIT, you can automatically instrument your 智能体s to gain full visibility into LLM calls, tool usage, costs, performance metrics, and errors.
...
2. **Deploy OpenLIT**
   ...
   **Other Deployment Options:**
   ...
   For production deployments, Kubernetes with Helm, or other infrastructure setups, see the [OpenLIT 安装ation Guide](https://docs.openlit.io/latest/openlit/installation) for detailed instructions on:
...
This example demonstrates how to instrument your Agno 智能体 with OpenLIT for automatic tracing.
...
For 本地 development without a collector, OpenLIT can output traces directly to the console:
...
OpenLIT automatically traces complex multi-智能体 workflows:
...
Once your 智能体s are instrumented, you can access the OpenLIT dashboard to:

- **查看 Traces**: Visualize complete execution flows including 智能体 runs, tool calls, and LLM requests
- **Monitor Performance**: Track latency, token usage, and throughput metrics
- **Analyze Costs**: Monitor API costs across different 模型s and 提供商s
- **Track Errors**: Identify and debug exceptions with detailed stack traces
- **Compare Models**: Evaluate different LLM 提供商s based on performance and cost
...
- **Automatic Instrumentation**: OpenLIT automatically instruments supported LLM 提供商s (OpenAI, Anthropic, etc.) and frameworks
...
- **Open-Source & Self-Hosted**: OpenLIT is fully open-source 并运行s on your own infrastructure for complete 数据 privacy and control

## Integration with Other Platforms

[OpenLIT](https://openlit.io/) can export traces to other observability 平台s like Grafana Cloud, New Relic and 更多功能. See the [Langfuse 集成 guide](/integrations/observability/langfuse) for an example of using OpenLIT with Langfuse.
