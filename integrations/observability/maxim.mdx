---
title: Maxim
description: Connect Agno with Maxim to monitor, trace, and evaluate your 智能体's activity and performance.
---

## Integrating Agno with Maxim

Maxim AI provides comprehensive 智能体 monitoring, evaluation, and observability for your Agno applications. With Maxim's one-line 集成, you can easily trace and analyse 智能体 interactions, performance metrics, and 更多功能.
...
This example demonstrates how to instrument your Agno 智能体 with Maxim and send traces for monitoring and evaluation.
...
This example demonstrates how to set up a multi-智能体 system with comprehensive Maxim tracing using the Team class.
...
Maxim provides comprehensive observability for your Agno 智能体s:

- **Agent Tracing**: Track your 智能体's complete lifecycle, including tool calls, 智能体 trajectories, and decision flows
- **Token 使用方法**: Monitor prompt and completion token consumption
- **Model Information**: Track which 模型s are being used and their performance
...
- **Instrumentation Order**: Call `instrument_agno()` **before** creating or executing any 智能体s to ensure proper tracing.
- **Debug Mode**: Enable debug mode to see detailed logging information:

  ```python
  instrument_agno(Maxim().logger(), {"debug" : True})
  ```
- **Maxim Docs**: For 更多功能 information on Maxim's 特性 and 功能, refer to the [Maxim 文档ation](https://getmaxim.ai/docs).

By 以下 these steps, you can effectively integrate Agno with Maxim, enabling comprehensive observability, evaluation, and monitoring of your AI 智能体s.