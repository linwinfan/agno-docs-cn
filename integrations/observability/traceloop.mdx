---
title: Traceloop
description: Integrate Agno with Traceloop to send traces and gain insights into your 智能体's performance.
---

## Integrating Agno with Traceloop

[Traceloop](https://www.traceloop.com/) provides an LLM observability 平台 built on [OpenLLMetry](https://github.com/traceloop/openllmetry), an open-source OpenTelemetry extension. By integrating Agno with Traceloop, you can automatically trace 智能体 execution, team workflows, tool calls, and token usage metrics.
...
Initialize Traceloop at the start of your application. The SDK automatically instruments Agno 智能体 execution.
...
For 本地 development, disable batching to see traces immediately:
...
Team execution is automatically traced, showing the coordination between multiple 智能体s:
...
Async 智能体 execution is fully supported with automatic tool call tracing:
...
- **Initialization**: Call `Traceloop.init()` before creating any 智能体s to ensure proper instrumentation.
