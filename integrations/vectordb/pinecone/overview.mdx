...
sidebarTitle: 概览
description: Learn how to use Pinecone as a vector 数据库 for your Knowledge Base
---
...
<Card title="Async Support ⚡">
  <div className="mt-2">
    <p>
      Pinecone also 支持 异步 operations, enabling concurrency and leading to better performance.
    </p>
...
- 查看 [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/pinecone_db/pinecone_db.py)