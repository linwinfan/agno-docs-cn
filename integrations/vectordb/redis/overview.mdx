...
sidebarTitle: 概览
description: Learn how to use Redis as a vector 数据库 for your Knowledge Base
---

<Badge icon="code-branch" color="orange">
    <Tooltip tip="Introduced in v2.2.7" cta="查看 release notes" href="https://github.com/agno-agi/agno/releases/tag/v2.2.7">v2.2.7</Tooltip>
</Badge>

You can use Redis as a vector 数据库 with Agno.
...
For a 本地 docker setup, you can use the 以下 command:
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/redis_db/redis_db.py)
