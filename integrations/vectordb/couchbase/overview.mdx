...
sidebarTitle: 概览
description: Learn how to use Couchbase as a vector 数据库 for your Knowledge Base
---
...
Run Couchbase 本地ly using Docker:
...
1. Access the Couchbase UI at: http://本地host:8091
...
For a managed cluster, use [Couchbase Capella](https://云.couchbase.com/):
- Follow Capella's UI to create a 数据库, bucket, scope, and collection
...
<Card title="Async Support ⚡">
  <div className="mt-2">
    <p>
      Couchbase also 支持 异步 operations, enabling concurrency and leading to better performance.
    </p>
...
Use `KnownConfigProfiles.WanDevelopment` for both 本地 and 云 deployments to handle network latency and timeouts appropriately.
...
- 查看 [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/couchbase_db/couchbase_db.py)
- 查看 [Cookbook (Async)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/couchbase_db/async_couchbase_db.py)