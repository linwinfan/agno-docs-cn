...
sidebarTitle: 概览
description: Learn how to use Azure Cosmos DB MongoDB vCore as a vector 数据库 for your Knowledge Base
---
...
## Azure Cosmos DB MongoDB vCore 参数
...
- 查看 [Cookbook (Sync)](https://github.com/agno-agi/agno/blob/main/cookbook/08_knowledge/vector_db/mongo_db/cosmos_mongodb_vcore.py)
