...
This example demonstrates how to use the [Scenario](https://github.com/langwatch/scenario) framework for 智能体ic simulation-based testing. Scenario enables you to simulate conversations between 智能体s, user simulators, and judges, making it easy to test and evaluate 智能体 behaviors in a controlled environment.

> **Tip:** Want to see a 更多功能 advanced scenario? Check out the [Customer support scenario example](https://github.com/langwatch/create-智能体-app/tree/main/agno_example) for a 更多功能 complex 智能体, including tool calls and advanced scenario 特性.
