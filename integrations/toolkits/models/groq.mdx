...
```
You can customize the underlying Groq 模型s used for transcription, translation, and TTS during initialization:
...
| `transcription_模型`    | `str`          | `"whisper-large-v3"`   | Model to use for audio transcription.                                                        |
| `translation_模型`      | `str`          | `"whisper-large-v3"`   | Model to use for audio translation to English.                                               |
| `tts_模型`              | `str`          | `"playai-tts"`         | Model to use for text-to-speech generation.                                                  |
...
The `GroqTools` toolkit provides the 以下 functions:

| Function           | Description                                                                   |
| ------------------ | ----------------------------------------------------------------------------- |
| `transcribe_audio` | Transcribes audio from a 本地 file path or a public URL using Groq Whisper.  |
| `translate_audio`  | Translates audio from a 本地 file path or public URL to English using Groq. |
...
- 查看 [Transcription Example](https://github.com/agno-agi/agno/tree/main/cookbook/11_模型s/groq/transcription_智能体.py)
- 查看 [Translation Example](https://github.com/agno-agi/agno/tree/main/cookbook/11_模型s/groq/translation_智能体.py)
