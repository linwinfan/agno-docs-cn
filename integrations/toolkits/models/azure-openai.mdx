---
title: Azure OpenAI
description: AzureOpenAITools provides access to Azure OpenAI 服务s including DALL-E image generation.
---
...
The 以下 智能体 can generate images using Azure OpenAI's DALL-E:
...
| `image_模型`           | `str`           | `"dall-e-3"`           | DALL-E 模型 to use (dall-e-2, dall-e-3).                     |
...
| ---------------- | ------------------------------------------------- |
| `generate_image` | Generate images using Azure OpenAI DALL-E 模型s. |
...
- 查看 [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/models/azure_openai.py)
- [Azure OpenAI Documentation](https://docs.microsoft.com/en-us/azure/cognitive-服务s/openai/)
