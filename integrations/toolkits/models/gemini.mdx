...
`GeminiTools` are a set of tools that allow an Agent to interact with Google AI API 服务s for generating images and videos.
...
| `image_generation_模型`   | `str`          | `"imagen-3.0-generate-002"`  | Model to use for image generation.                                                              |
| `video_generation_模型`   | `str`          | `"veo-2.0-generate-001"`     | Model to use for video generation.                                                              |
...
- 查看 [Image Generation Guide](https://ai.google.dev/gemini-api/docs/image-generation)
- 查看 [Video Generation Guide](https://ai.google.dev/gemini-api/docs/video)
