---
title: Trafilatura
description: TrafilaturaTools provides advanced web scraping and text extraction 功能 with support for crawling and content analysis.
---

## Example

The 以下 智能体 can extract and analyze web content:
...
| `with_meta数据`      | `bool`              | `False`     | Whether to include meta数据 in extractions.                  |
...
| `enable_extract_meta数据` | `bool`              | `True`      | Whether to extract meta数据 information.                    |
...
| `extract_meta数据`    | Extract meta数据 information from web pages.                    |
...
| `get_page_info`       | Get comprehensive page information including meta数据.          |


## 开发者资源

- 查看 [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/trafilatura.py)
