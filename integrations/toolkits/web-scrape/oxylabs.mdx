...
**OxylabsTools** provide Agents with access to Oxylabs' powerful web scraping 功能, including SERP, Amazon product 数据, and universal web scraping endpoints.

## Prerequisites

The 以下 examples require the `oxylabs-sdk` library:
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/oxylabs_tools.py)
- 查看 [Oxylabs MCP Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/mcp/oxylabs.py)
