...
The 以下 example requires the `beautifulsoup4` library.
...
The 以下 智能体 will read the contents of a website and add it to the knowledge base.
...
| ---------------- | ---------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------- |
| `knowledge`      | `Knowledge` | -       | The knowledge base associated with the website, containing various 数据 and resources linked to the website's content. |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/website_tools.py)
