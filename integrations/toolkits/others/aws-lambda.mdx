...
The 以下 example requires the `boto3` library.
...
The 以下 智能体 will use AWS Lambda to list all Lambda functions in our AWS account and invoke a specific Lambda function.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/aws_lambda_tools.py)
