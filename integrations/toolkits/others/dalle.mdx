...
The 以下 智能体 will use DALL-E to generate an image based on a text prompt.
...
| --------- | ----- | ------------- | ----------------------------------------------------------------- |
| `模型`   | `str` | `"dall-e-3"`  | The DALL-E 模型 to use              |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/dalle_tools.py)
