...
**GithubTools** enables an Agent to access Github repositories and perform tasks such as listing open pull requests, issues and 更多功能.

## Prerequisites

The 以下 examples requires the `PyGithub` library and a Github access token which can be obtained from [here](https://github.com/settings/tokens).
...
The 以下 智能体 will search Google for the latest news about "Mistral AI":
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/github_tools.py)
