...
This guide demonstrates how to integrate and use [Apify](https://apify.com/actors) Actors within the Agno framework to enhance your AI 智能体s with web scraping, crawling, 数据 extraction, and web automation 功能.

## What is Apify?

[Apify](https://apify.com/) is a 平台 that provides:
- Data collection 服务s for AI Agents, specializing in extracting 数据 from social media, search engines, online maps, e-commerce sites, travel portals, or general websites
- A marketplace of ready-to-use Actors (specialized tools) for various 数据 tasks
- Infrastructure to run and monetize our own AI Agents

## Prerequisites

1. Sign up for an [Apify account](https://console.apify.com/sign-up)
2. Obtain your Apify API token (can be obtained from [Apify](https://docs.apify.com/平台/integrations/api))
3. 安装 the required packages:
...
The Agno framework makes it easy to integrate Apify Actors into your 智能体s. Here's a simple example:
...
The [RAG Web Browser](https://apify.com/apify/rag-web-browser) Actor is specifically designed for AI and LLM applications. It searches the web for a query or processes a URL, then cleans and formats the content for your 智能体. This tool is enabled by default.
...
The [Google Places Crawler](https://apify.com/compass/crawler-google-places) extracts 数据 about businesses from Google Maps and Google Places.
...
This example combines web search with 本地 business 数据 to provide comprehensive information about a topic:
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/apify_tools.py)

## 资源

- [Apify Actor Documentation](https://docs.apify.com/Actors)
- [Apify Store - Browse available Actors](https://apify.com/store)
- [How to build and monetize an AI 智能体 on Apify](https://blog.apify.com/how-to-build-an-ai-智能体/)