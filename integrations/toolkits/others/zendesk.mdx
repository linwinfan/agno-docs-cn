...
The 以下 example requires the `requests` library and auth credentials.
...
The 以下 智能体 will run seach Zendesk for "How do I login?" and print the response.
...
| `company_name` | `str` | -       | The name of the company related to the user or the 数据 being accessed. |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/zendesk_tools.py)
