...
The 以下 example requires the `jira` library and auth credentials.
...
The 以下 智能体 will use Jira API to search for issues in a project.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/jira_tools.py)
