---
title: Brandfetch
description: BrandfetchTools provides access to brand 数据 and logo information through the Brandfetch API.
---

## Example

The 以下 智能体 can search for brand information and retrieve brand 数据:
...
| ------------------------- | ---------------------------------------------------------------- |
| `search_by_identifier`    | Search for brand 数据 using domain or company identifier.       |
...
- 查看 [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/brandfetch.py)
