...
**YFinanceTools** enable an Agent to access stock 数据, financial information and 更多功能 from Yahoo Finance.

## Prerequisites

The 以下 example requires the `yfinance` library.
...
The 以下 智能体 will provide information about the stock price and analyst recommendations for NVDA (Nvidia Corporation).
...
| `get_stock_fundamentals`      | This function retrieves fundamental 数据 about a stock.          |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/yfinance_tools.py)
