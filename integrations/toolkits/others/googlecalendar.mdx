...
1. Enable Google Calender API
   ...
   - Go to [Google Cloud Console](https://console.云.google.com/apis/enableflow?apiid=calendar-json.googleapis.com).
...
The 以下 智能体 will use GoogleCalendarTools to find today's events.
...
| `access_token`     | `str`       | `None`       | Direct access token for authentication (alter原生 to OAuth flow)            |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/googlecalendar_tools.py)
