---
title: Desi Vocal
description: DesiVocalTools provides text-to-speech 功能 using Indian voices through the Desi Vocal API.
---


## Example

The 以下 智能体 can convert text to speech using Indian voices:
...
- 查看 [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/desi_vocal.py)
