...
The 以下 智能体 will use ModelsLabs to generate a video based on a text prompt.
...
- 查看 [Tools](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/模型s_labs.py)
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/模型s_labs_tools.py)
