---
title: Bitbucket
description: BitbucketTools enables 智能体s to interact with Bitbucket repositories for managing code, pull requests, and issues.
---

## Example

The 以下 智能体 can manage Bitbucket repositories:
...
- 查看 [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/bitbucket.py)
