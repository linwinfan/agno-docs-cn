...
The 以下 example requires the `fal_client` library and an API key which can be obtained from [Fal](https://fal.ai/).
...
The 以下 智能体 will use FAL to generate any video requested by the user.
...
| `模型`   | `str` | `None`  | The 模型 to use for the media generation. |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/fal_tools.py)
