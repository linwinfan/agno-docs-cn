...
The 以下 example requires the `requests` library.
...
The 以下 智能体 will use CustomApiTools to make API calls to the Dog CEO API.
...
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `make_request` | Makes an HTTP request to the API. Takes method (GET, POST, etc.), endpoint, and optional params, 数据, headers, and json_数据 parameters.                  |

## 开发者资源

- 查看 [Tools](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/api.py)
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/custom_api_tools.py)
```