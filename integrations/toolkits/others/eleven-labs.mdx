...
The 以下 智能体 will use Eleven Labs to generate audio based on a user prompt.
...
| `模型_id`         | `str`           | `eleven_multilingual_v2` | The 模型's id to use for the audio generation                                                                                                                                 |
| `output_format`    | `str`           | `mp3_44100_64`           | The output format to use for the audio generation (check out [the docs](https://elevenlabs.io/docs/api-reference/text-to-speech#parameter-output-format) for 更多功能 information) |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/elevenlabs_tools.py)
