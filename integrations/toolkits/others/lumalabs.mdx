...
**LumaLabTools** enables an Agent to generate media using the [Lumalabs 平台](https://lumalabs.ai/dream-machine).
...
The 以下 example requires the `lumaai` library. To install the Lumalabs client, run the 以下 command:
...
The 以下 智能体 will use Lumalabs to generate any video requested by the user.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/lumalabs_tools.py)
