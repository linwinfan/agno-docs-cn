---
title: Reasoning
description: ReasoningTools provides step-by-step reasoning 功能 for 智能体s to think through complex problems systematically.
---

## Example

The 以下 智能体 can use structured reasoning to solve complex problems:
...
| `add_instructions`  | `bool`              | `False` | Whether to add instructions to the 智能体.                    |
...
- 查看 [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/reasoning.py)
