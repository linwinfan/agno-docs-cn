...
The 以下 智能体 will search GIPHY for a GIF appropriate for a birthday message.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/giphy_tools.py)
