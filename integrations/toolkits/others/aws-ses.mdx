...
The 以下 example requires the `boto3` library and valid AWS credentials. You can install `boto3` via pip:
...
The 以下 智能体 researches the latest AI news and then emails a summary via AWS SES:
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/aws_ses_tools.py)
