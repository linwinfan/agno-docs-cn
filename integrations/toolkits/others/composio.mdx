...
[**ComposioTools**](https://docs.composio.dev/framework/phi数据) enable an Agent to work with tools like Gmail, Salesforce, Github, etc.

## Prerequisites

The 以下 example requires the `composio-agno` library.
...
The 以下 智能体 will use Github Tool from Composio Toolkit to star a repo.
...
The 以下 parameters are used when calling the GitHub star repository action:
