...
The 以下 example requires the `resend` library and an API key from [Resend](https://resend.com/).
...
The 以下 智能体 will send an email using Resend
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/resend_tools.py)
