...
| `提供商`                     | `str`     | `"yfinance"`         | Data 提供商 for financial information. Options: "benzinga", "fmp", "intrinio", "polygon", "tiingo", "tmx", "yfinance". |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/openbb_tools.py)
