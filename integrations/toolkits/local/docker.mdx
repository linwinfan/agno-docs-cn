...
The Docker tools require the `docker` Python package. You'll also need Docker installed 并运行ning on your system.
...
The 以下 example creates an 智能体 that can manage Docker resources:
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/docker_tools.py)