...
The 以下 智能体 will use the `sleep` tool to pause execution for a given number of seconds.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/sleep_tools.py)
