...
The 以下 智能体 will run a shell command and show contents of the current directory.

<Note>
  Mention your OS to the 智能体 to make sure it runs the correct command.
</Note>
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/shell_tools.py)
