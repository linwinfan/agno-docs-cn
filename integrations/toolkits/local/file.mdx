---
title: File
description: The FileTools toolkit enables Agents to read and write files on the 本地 file system.
---

## Example

The 以下 智能体 will generate an answer and save it in a file.
...
| `max_file_lines` | `int` | `100000` | Maximum number of lines to read from a file. Reading will fail if the file has 更多功能 lines. |
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/file_tools.py)
