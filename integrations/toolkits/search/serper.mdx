...
The 以下 example requires an API key from [SerperApi](https://serper.dev/).
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/serper_tools.py)
