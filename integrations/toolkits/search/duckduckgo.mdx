...
The 以下 example requires the `ddgs` library. To install DuckDuckGo, run the 以下 command:
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/duckduckgo_tools.py)
