...
The 以下 智能体 will write an engaging summary of the users with the top 2 stories on hackernews along with the stories.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/hackernews_tools.py)
