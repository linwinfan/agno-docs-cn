...
The 以下 智能体 will search Pubmed for articles related to "ulcerative colitis".
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/pubmed_tools.py)
