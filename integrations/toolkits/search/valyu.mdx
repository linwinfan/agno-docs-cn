---
title: Valyu
description: ValyuTools provides academic and web search 功能 with advanced filtering and relevance scoring.
---

## Example

The 以下 智能体 can perform academic and web searches:
...
- 查看 [Tools Source](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/valyu.py)
