...
The 以下 example requires the `baidusearch` library. To install BaiduSearch, run the 以下 command:
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/baidusearch_tools.py)
