...
<Note>
  {" "}
  Check out the [Tweet Analysis Agent](/examples/use-cases/智能体s/tweet-analysis-智能体)
  for a 更多功能 advanced example.{" "}
</Note>
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/x_tools.py)
- 查看 [Tweet Analysis Agent Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/02_examples/智能体s/social_media_智能体.py)
