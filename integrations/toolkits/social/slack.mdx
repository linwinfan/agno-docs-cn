...
The 以下 example requires the `slack-sdk` library.
...
The 以下 智能体 will use Slack to send a message to a channel, list all channels, and get the message history of a specific channel.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/slack_tools.py)
