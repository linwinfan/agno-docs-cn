...
**DiscordTools** enable an 智能体 to send messages, read message history, manage channels, and delete messages in Discord.

## Prerequisites

The 以下 example requires a Discord bot token which can be obtained from [here](https://discord.com/developers/applications).
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/discord.py)
