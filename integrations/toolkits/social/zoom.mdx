...
The Zoom toolkit requires the 以下 setup:

1. 安装 required dependencies:
...
- Recording endpoints: Lower rate limits, check Zoom 文档ation
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/14_tools/zoom_tools.py)
