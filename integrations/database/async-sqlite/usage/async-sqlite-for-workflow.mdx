...
Agno 支持 using SQLite 异步ly as a 存储 backend for Workflows, with the `AsyncSqliteDb` class.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/07_数据库/sqlite/async_sqlite/async_sqlite_for_workflow.py)
