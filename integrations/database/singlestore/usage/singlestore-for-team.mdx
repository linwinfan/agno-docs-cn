...
Agno 支持 using Singlestore as a 存储 backend for Teams using the `SingleStoreDb` class.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/tree/main/cookbook/07_数据库/singlestore/singlestore_for_team.py)
