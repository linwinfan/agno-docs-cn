...
Agno 支持 using DynamoDB as a 存储 backend for Teams using the `DynamoDb` class.
...
- 查看 [Cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/07_数据库/dynamodb/dynamo_for_team.py)
