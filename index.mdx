---
title: 欢迎使用 Agno
description: 使用 Agno 构建、运行和管理多智能体系统。领先的框架，用于创建具有强大工具和部署选项的 AI 智能体、团队和工作流。
mode: custom
---
...
export const codeTabs = [
    {
        ...
        code: (
          <>
            ...
            agent.print_response(<span style={{color:'#c3e88d'}}>"撰写关于热门创业公司的报告"</span>, stream=<span style={{color:'#ff4017'}}>True</span>)
          </>
        ),
    },
    {
        ...
        code: (
          <>
            ...
            {'\n'}
            hn_researcher = Agent({'\n'}
            {'    '}name=<span style={{color:'#c3e88d'}}>"HackerNews 研究员"</span>,{'\n'}
            {'    '}tools=[HackerNewsTools()],{'\n'}
            ){'\n'}
            article_reader = Agent({'\n'}
            {'    '}name=<span style={{color:'#c3e88d'}}>"文章阅读器"</span>,{'\n'}
            {'    '}tools=[Newspaper4kTools()],{'\n'}
            ){'\n'}
            {'\n'}
            team = Team(members=[hn_researcher, article_reader]){'\n'}
            team.print_response(<span style={{color:'#c3e88d'}}>"研究 AI 趋势并总结热门文章"</span>)
          </>
        ),
    },
    {
        ...
        code: (
          <>
            ...
            {'\n'}
            researcher = Agent(name=<span style={{color:'#c3e88d'}}>"研究员"</span>, tools=[DuckDuckGoTools()]){'\n'}
            writer = Agent(name=<span style={{color:'#c3e88d'}}>"写作者"</span>, instructions=<span style={{color:'#c3e88d'}}>"撰写引人入胜的内容"</span>){'\n'}
            {'\n'}
            workflow = Workflow({'\n'}
            {'    '}name=<span style={{color:'#c3e88d'}}>"内容工作流"</span>,{'\n'}
            {'    '}description=<span style={{color:'#c3e88d'}}>"用于创建内容的工作流"</span>,{'\n'}
            {'    '}steps=[researcher, writer],{'\n'}
            ){'\n'}
            {'\n'}
            workflow.print_response(<span style={{color:'#c3e88d'}}>"创建关于 AI 智能体的博客文章"</span>, stream=<span style={{color:'#ff4017'}}>True</span>)
          </>
        ),
    },
    {
  ...
  <div className="relative mx-auto flex max-w-6xl flex-col px-5 sm:px-8 lg:px-10">
    ...
    <section className="mt-20 flex flex-col items-center gap-6 text-center">
      ...
      <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        >
          ...
          <h3 className="text-base font-semibold text-start text-zinc-900 dark:text-zinc-100">入门指南</h3>
    ...
    <section className="mt-20 pb-12">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-5 sm:px-8 lg:grid-cols-5 lg:px-10">
        <div>
          <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">入门指南</h3>
          <ul className="space-y-3">
            <li><a href="/get-started/quickstart" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">快速开始</a></li>
            <li><a href="/get-started/getting-help" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">获取帮助</a></li>
          </ul>
        </div>

        <div>
          <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">基础概念</h3>
          <ul className="space-y-3">
            <li><a href="/basics/agents/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">智能体</a></li>
            <li><a href="/basics/teams/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">团队</a></li>
            <li><a href="/basics/workflows/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">工作流</a></li>
            <li><a href="/basics/tools/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">工具</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="/agent-os/introduction" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">概述</a></li>
            <li><a href="/agent-os/creating-your-first-os" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">入门指南</a></li>
            <li><a href="/agent-os/config" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">配置</a></li>
            <li><a href="/deploy/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">部署</a></li>
          </ul>
        </div>

        <div>
          <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">参考文档</h3>
          <ul className="space-y-3">
            <li><a href="/reference/agents/agent" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">SDK 参考</a></li>
            <li><a href="/reference-api/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">API 参考</a></li>
            <li><a href="/examples/use-cases/overview" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">示例</a></li>
            {/* <li><a href="/templates/overview" className="text-sm text-zinc-500 transition hover:text-[#ff4017]">模板</a></li> */}
          </ul>
        </div>

        <div>
          <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">社区</h3>
          <ul className="space-y-3">
