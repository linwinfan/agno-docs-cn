...
Build a sophisticated investment analysis system that combines market re搜索, financial analysis, and portfolio management. This 工作流 analyzes stocks, evaluates investment potential, and generates strategic portfolio 所有ocation recommendations.

## What You'll 学习

By building this 工作流, you'll 理解:
- How to structure multi-stage financial analysis 工作流s
- How to integrate web 搜索 for real-time market re搜索
- How to rank and compare investment opportunities systematic所有y
- How to generate comprehensive investment reports with rationale

## 使用 Cases

Build investment re搜索 platforms, portfolio analysis 工具s, financial advisory systems, or automated stock screening 应用程序s.

## How It Works

The 工作流 follows a three-stage investment analysis process:

1. **Re搜索**: Market analyst 代理 uses DuckDuckGo to gather comprehensive 信息 on each stock
2. **Evaluate**: Investment analyst ranks stocks by potential and provides 详细信息ed rationale
3. **Allocate**: Portfolio manager creates strategic 所有ocation recommendations based on rankings
4. **Report**: Generates a professional investment report with analysis and recommendations

The 工作流 processes multiple stocks simultaneously and provides comparative analysis.
...
The 工作流 analyzes multiple stocks through three phases: market re搜索, investment evaluation, and portfolio 所有ocation. You'll 查看 re搜索 findings for each stock, comparative rankings with investment rationale, and strategic 所有ocation recommendations.

The final output is a comprehensive investment report with 详细信息ed analysis of each stock, risk assessment, and portfolio 所有ocation strategy based on systematic evaluation criteria.
...
- Modify the 示例 stock tickers in the code to analyze different companies
- Customize analyst 说明 to focus on specific investment criteria
- Adjust portfolio 所有ocation strategy based on your risk preferences
