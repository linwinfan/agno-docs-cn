...
构建一个复杂的投资分析系统，结合市场研究、财务分析和投资组合管理。此工作流分析股票，评估投资潜力，并生成战略性投资组合配置建议。
...
构建投资研究平台、投资组合分析工具、财务顾问系统或自动化股票筛选应用程序。

## 工作原理

工作流遵循三阶段投资分析流程：

1. **研究**: 市场分析师代理使用DuckDuckGo收集每只股票的全面信息
2. **评估**: 投资分析师根据潜力对股票进行排名并提供详细的理由
3. **配置**: 投资组合经理根据排名创建战略性配置建议
4. **报告**: 生成包含分析和建议的专业投资报告
...
工作流通过三个阶段（市场研究、投资评估和投资组合配置）分析多只股票。您将看到每只股票的研究发现、包含投资理由的比较排名以及战略性配置建议。

最终输出是一份全面的投资报告，包含对每只股票的详细分析、风险评估以及基于系统性评估标准的投资组合配置策略。
