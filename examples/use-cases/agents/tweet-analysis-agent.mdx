...
密钥 capabilities:
- Real-time tweet analysis and sentiment 类ification
...
<Note> Check out the 详细信息ed [Social Media Agent](https://github.com/agno-agi/agno/tree/main/cookbook/02_示例/代理s/social_media_代理.py). </Note>
...
- "Identify trending topics and user sentiment 关于 our product"
- "Create a social media intelligence report for executive re查看"
