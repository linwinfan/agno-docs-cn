...
此示例展示如何创建一个超越简单文本翻译的智能翻译智能体。该智能体：

- **翻译文本**：从一种语言翻译到另一种语言
- **分析情感内容**：在翻译文本中分析情感
- **选择合适的语音**：基于语言和情感选择语音
- **创建本地化语音**：使用 Cartesia 的语音本地化工具
- **生成音频输出**：具有情感适当的语音特征

The 代理 uses a step-by-step approach to ensure high-quality translation and voice generation, making it ideal for creating localized content that maintains the emotional tone of the original text.
