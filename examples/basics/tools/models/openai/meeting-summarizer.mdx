...
此示例演示 a multi-modal meeting summarizer and visualizer 代理 that uses OpenAITools and ReasoningTools to transcribe a meeting recording, extract key insights, generate a visual summary, and synthesize an audio summary.
