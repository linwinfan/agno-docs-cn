...
此示例演示 an asynchronous multi-purpose reasoning 团队 that uses reasoning 工具s to analyze questions and delegate to appropriate specialist 代理s asynchronously, showcasing coordination and intelligent task routing.
